    ...
    <DrawerContentScrollView {...props} contentContainerStyle={{ flex: 1, justifyContent: 'space-between' }}>
      <View>
        <View style={{ padding: 20, backgroundColor: '#5B2D8E', marginBottom: 10 }}>
          <Text style={{ color: 'white', fontSize: 18, fontWeight: 'bold' }}>Hello, {user?.name || 'Student'}!</Text>
          <Text style={{ color: '#D1C4E9', fontSize: 14 }}>{user?.email || ''}</Text>
        </View>
    ...
    <DrawerContentScrollView {...props} contentContainerStyle={{ flex: 1, justifyContent: 'space-between' }}>
      <View>
        <View style={{ padding: 20, backgroundColor: '#2E7D32', marginBottom: 10 }}>
          <Text style={{ color: 'white', fontSize: 18, fontWeight: 'bold' }}>Hello, {user?.name || 'Owner'}!</Text>
          <Text style={{ color: '#C8E6C9', fontSize: 14 }}>{user?.email || ''}</Text>
        </View>
        <DrawerItemList {...props} />
      </View>
      <TouchableOpacity
